...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Pridėti naują pratimų kategoriją</h2>
            </div>
            <div class="pull-right mt-3">
                <a class="btn btn-primary" href="{{ route('categ') }}"> Atgal</a>
            </div>
        </div>
    </div>

    <form class="mt-3" action="{{ route('createExerCategory') }}" method="POST"  enctype="multipart/form-data">
        @csrf
