            ...
            <div class="w3-row-padding d-flex justify-content-center mt-5" >
                ...
                @if($i<count($articles))
                    <div class="w3-quarter w3-container w3-margin-bottom col-sm-4 ">
                        <a href="/exercisesDesc/{{$articles[$i] -> id}}" style="text-decoration: none">
                ...
                @if($i+1<count($articles))
                    <div class="w3-quarter w3-container w3-margin-bottom col-sm-4">
                        <a href="/exercisesDesc/{{$articles[$i+1] -> id}}" style="text-decoration: none">
                            <div class="w3-container w3-white  embed-responsive w3-padding-16">
                ...
                @if($i+2<count($articles))
                    <div class="w3-quarter w3-container w3-margin-bottom col-sm-4">
                        <a href="/exercisesDesc/{{$articles[$i+2] -> id}}" style="text-decoration: none">
                            <div class="w3-container w3-white  embed-responsive w3-padding-16">
